...
import { hasProperty, isBoolean, isFunction, isNumber, isString } from "../../lib/JST/native/type_check.js";
...
export const Heroes = (() => {
    ...
    core.getCurrentInventory = () => current.getInventory().getAll().map((itemId) => cache.getItem(itemId));
...
export const Scenes = (() => {
    ...
    core.getCurrentElements = () => current.getAllElements().map((elemId) => cache.getItem(elemId));
