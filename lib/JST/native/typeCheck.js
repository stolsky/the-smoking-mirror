...
const EventType = {
    ...
    input: "input",
    keyup: "keyup",
    /** @deprecated will be replaced with pointerenter */
    mouseenter: "mouseenter",
    /** @deprecated will be replaced with pointerleave */
    mouseleave: "mouseleave",
    /** @deprecated is replaced with pointerup */
    mouseup: "mouseup",
    pointerup: "pointerup",
 ...
 * @returns {boolean}
 */
const hasProperty = (obj, prop) => obj instanceof Object && isString(prop) && Object.hasOwn(obj, prop);
 ...
 * @returns {boolean}
 */
const hasValue = (obj, val) => obj instanceof Object && Object.values(obj).includes(val);
